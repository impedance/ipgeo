...
Gem::Specification.new do |spec|
  ...
  spec.authors       = ['Alexander Inozemtsev']
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/impedance/ipgeobase'
  spec.metadata['changelog_uri'] = 'https://github.com/impedance/ipgeobase'
